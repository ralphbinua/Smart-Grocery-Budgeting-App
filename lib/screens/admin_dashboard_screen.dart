                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (ctx, i) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            title: Text(p['name'] ?? 'Unknown', style: const TextStyle(color: AppColors.textPrimary, fontWeight: FontWeight.bold)),
                            subtitle: Text('Barcode: ${p['barcode']} \nPrice: ₱${p['latestPrice']}', style: const TextStyle(color: AppColors.textSecondary)),
                            trailing: Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
